...
测试覆盖：35 个动作两侧与 5 个阶段的骨长、男女人物渲染（绘图参数均为有限数值）、固定支撑点、固定肘部、动作节奏曲线、坐站起身顺序、轨迹箭头、扬声器时钟、数拍准时结束、箭头不出画面、休息预览、掉帧降级、随机方案覆盖、四拍录音数据、音频启动竞争条件、静音/暂停/恢复、自动休息/换项、单文件完整性。浏览器检查使用 360×640 和 390×844 竖屏尺寸；这不是小米真机扬声器测试。
